 ...
 * @brief new string
 *
 * the string is not allocated, therefore vstr_c_str() returns NULL
 *
 * @param s Vstr
 */
 ...
 *
 * the string has 0 length but is allocated, therefore vstr_c_str() is valid
 *
 * @param s Vstr
